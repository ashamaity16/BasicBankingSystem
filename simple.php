 ...
 if(isset($_POST['submit']))
 {
      ...
      else if($input['amt'] == 0)
    {
     ...
     else
      {
                ...
                $sql4 ="UPDATE accounts SET `balance`= $update_bal WHERE id = ". $input['from'];
                mysqli_query($conn,$sql4);

                $update_bal = $sql2['balance'] + $input['amt'];
                $sql5 ="UPDATE accounts SET `balance`= $update_bal WHERE id = ". $input['to'];
                ...
                $sql ="INSERT INTO transaction(`sender`, `receiver`, `balance`) VALUES ('$sender','$receiver','$tranfer_amt')";
